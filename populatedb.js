...
async function createBookInstances() {
    ...
    await Promise.all([
        ...
        bookInstanceCreate(2, books[1], " Gollancz, 2015.", false, false),
        bookInstanceCreate(3, books[3], "New York Tom Doherty Associated, 2016.", false, "Available"),
        bookInstanceCreate(4, books[3], "New York Tom Doherty Associates, 2016.", false, "Available"),
        bookInstanceCreate(5, books[3], "New York Tom Doherty Associated, 2016.", false, "Available"),
